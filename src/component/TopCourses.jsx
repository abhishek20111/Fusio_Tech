          ...
          <div className="flex flex-nowrap lg:ml-40 md:ml-20 sm:ml-0 ">
            {topCourse.map((course, index) => (
              <div className="inline-block px-3 " key={index}>
                <div
                  className="w-64 bg-white border border-gray-200 rounded-lg shadow hover:w-72 hover:translate-y-2 hover:shadow-lg hover:shadow-white transition-all duration-300 ease-in-out"
                  key={index}
                >
                  <a href="#">
                    <img
