...
const Internship = () => {
  ...
  return (
    <Fade>
      <Helmet>
        <title>FusioTech | Intership Page</title>
        <meta name="description" content="Fusiotech Intership Page" />
        <meta name="keywords" content="fusioTech, intership, Fusiotech, Home, Study, Contest, Education, Learning platform, course, buy courses, courses" />
      </Helmet>
      <div className="flex justify-center my-5 w-full">
        <div className="flex flex-wrap min-h-screen m-2">
          ...
          {sections.map((section, index) => (
              <div
                key={index}
                className="flex justify-center max-w-[400px] m-4 md:m-12"
              >
                <div
                ...
                >
                  ...
                  <div className="flex justify-center mt-4">
                    <a
                      href="https://forms.gle/ruvzAeq3UHnKQb457"
                      target="_blank"
