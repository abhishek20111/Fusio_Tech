          ...
          >
            <div className="w-full h-full my-1">
              ...
              <div className=" my-10 flex-col flex justify-center px-4  text-2xl md:w-[75%] md:text-4xl font-semibold">
                ...
                <p className="md:text-2xl px-5 md:py-2 py-1 font-normal outline-dashed outline-1 rounded-xl mt-3">
                  {course.description}
                </p>
              </div>
              <div className="my-10 flex-col flex justify-center px-4 text-2xl md:w-[75%] md:text-4xl font-semibold">
                <p className="italic md:text-3xl font-thin">Extra Info:</p>
                <p className="italic text-xl rounded-xl outline-dashed outline-1 p-3 font-thin">
                  {course.extraDescription}
                </p>
              </div>
              <div className=" my-10 px-4 pl-7 border-2 rounded-md mx-2 md:w-3/4 md:max-h-[200px] overflow-auto">
                <p className="md:text-3xl text-xl">Course Content:</p>
                <ol className="list-disc">
                  {course.syllabus.map((lesson, index) => (
                    <li key={index} className="my-2 md:text-xl">
                      {lesson}
                    </li>
                  ))}
                </ol>
