...
const UploadVideo = () => {
  ...
  return (
    <>
      <div className="flex flex-wrap md:flex-nowrap min-h-screen bg-gradient-to-r from-white to-white via-blue-100">
        <div className="my-5 mx-2 border-2 border-gray-300 w-full rounded-l-3xl ">
          <input
            ...
            className="m-2 mt-5 mb-5 px-4 py-8 border-4 focus:border placeholder:font-thin border-black rounded-md w-[95%] text-2xl md:w-[75%] h-[50px] md:text-4xl font-semibold"
          />
          ...
          <textarea
            ...
            onChange={handleInputChange2}
            className="mx-2 my-2 p-4 border w-[97%] border-gray-700 rounded-md md:text-2xl"
          ></textarea>
          <textarea
            ...
            onChange={handleInputChange2}
            className="mx-2 my-2 p-4 border placeholder:italic  w-[97%] border-gray-700 rounded-md font-thin md:text-xl"
          ></textarea>
