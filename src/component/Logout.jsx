...
import { resetState } from '../store/UserSilce.js';
...
const Logout = () => {
    ...
    return (
        <div className="min-w-screen relative flex min-h-screen flex-col items-center justify-center bg-white pt-4">
            ...
            <div className="fixed top-14 inset-x-0 flex items-center justify-center">
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg"
                    onClick={(e) => e.stopPropagation()}>
                    <div className="p-4 sm:p-10 text-center sm:block overflow-y-auto">
